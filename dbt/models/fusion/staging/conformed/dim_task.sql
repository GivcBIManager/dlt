...
-- conformed.dim_task -- Oracle Fusion warehouse, staged 1:1 into `fusion`.
--
-- GENERATED, then yours: this file was written from the warehouse schema, but
-- it is an ordinary model. Edit it freely; nothing regenerates it. (The source
-- declaration and the Iceberg path ARE regenerated -- see gui/ofusion_sources.py.)
--
-- Grain: task_id (UNVERIFIED -- table is empty)
...
,TOP_TASK_ID       as top_task_id
,CHARGEABLE_FLAG   as chargeable_flag
...
from {{ ofusion_source('dim_task', 'conformed') }}
{% if is_incremental() %}
