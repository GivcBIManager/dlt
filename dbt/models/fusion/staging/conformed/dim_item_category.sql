...
-- conformed.dim_item_category -- Oracle Fusion warehouse, staged 1:1 into `fusion`.
--
...
,CATEGORY_SET_ID       as category_set_id
,CATEGORY_SET_NAME     as category_set_name
,CATEGORY_ID           as category_id
,CATEGORY_CODE         as category_code
,CATEGORY_DESCRIPTION  as category_description
,ifNull(LAST_UPDATE_DATE, toDateTime64('1970-01-01 00:00:00', 6, 'UTC')) as last_update_date
from {{ ofusion_source('dim_item_category', 'conformed') }}
{% if is_incremental() %}
